...
HWND ajout_etudiant(HWND hwnd)
{
    ...
    but_tet_ajout= CreateWindow("Button","Ajouter en téte",BS_PUSHBUTTON | WS_CHILD |WS_EX_TRANSPARENT| WS_VISIBLE|WS_BORDER,345,370,120,35,hwnd,ID_AJOUT_TETE,hinst,0);
...
HWND ajout_matiere(HWND hwnd)
{
    ...
    pos_wind =CreateWindow("COMBOBOX", "",WS_CHILD|WS_VISIBLE|CBS_DISABLENOSCROLL|CBS_DROPDOWNLIST| WS_VSCROLL|WS_BORDER,540,419,60,150,hwnd,0,hinst,0);
    but_tet_ajout_mat= CreateWindow("Button","Ajouter en téte",BS_PUSHBUTTON | WS_CHILD |WS_EX_TRANSPARENT| WS_VISIBLE|WS_BORDER,345,370,120,35,hwnd,ID_AJOUT_TETE_MAT,hinst,0);
...
HWND ajout_notes(HWND hwnd)
{
    ...
    but_tet_ajout_note= CreateWindow("Button","Ajouter en téte",BS_PUSHBUTTON | WS_CHILD |WS_EX_TRANSPARENT| WS_VISIBLE|WS_BORDER,345,350,120,35,hwnd,ID_AJOUT_TETE_note,hinst,0);
